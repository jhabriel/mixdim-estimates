...
// Define points
p0 = newp; Point(p0) = {0.3, 0.2, 0.0, 0.1 };
p1 = newp; Point(p1) = {0.7, 0.8, 0.0, 0.1 };
p2 = newp; Point(p2) = {0.8, 0.2, 0.0, 0.1 };
p3 = newp; Point(p3) = {0.2, 0.8, 0.0, 0.1 };
...
p8 = newp; Point(p8) = {0.5, 0.5, 0.0, 0.1 };
