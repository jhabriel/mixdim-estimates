...
class ExactSolution2D:
    def __init__(self, gb: pp.GridBucket):
        ...
        self.g1d_rot = mde.RotatedGrid(self.g1d)
        ...
        middle_cells = (self.g2d.cell_centers[1] >= 0.25) & (
            self.g2d.cell_centers[1] <= 0.75
        )
        ...
        middle_bc = (self.g2d.face_centers[1] >= 0.25) & (
            self.g2d.face_centers[1] <= 0.75
        )
    ...
    def dir_bc_values(self):
        """
        Computation of the Dirichlet data for the bulk
