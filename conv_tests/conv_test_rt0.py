...
# p_coeffs = d_2d[pp.STATE]["p_coeff"]
# g = g_2d
...
# d_2d[pp.STATE]["efficiency_idx"] =  d_2d[pp.STATE]["error_DF"] / d_2d[pp.STATE]["true_error"]
# d_1d[pp.STATE]["efficiency_idx"] =  d_1d[pp.STATE]["error_DF"] * 0

# exporter.write_vtk([subdomain_variable, "error_DF", "true_error", "efficiency_idx"])
