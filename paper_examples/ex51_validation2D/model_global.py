...
def model_global(gb, method):
    ...
    diffusive_error_squared_mortar_left = d_e[pp.STATE]["diffusive_error"][int(mg.num_cells/2):]
    diffusive_error_squared_mortar_right = d_e[pp.STATE]["diffusive_error"][:int(mg.num_cells/2)]
