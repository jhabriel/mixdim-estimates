...
def model_LC(gb, method):
    ...
    out["bulk"]["diffusive_error"] = bulk_diffusive_squared ** 0.5
    out["bulk"]["residual_error"] = bulk_residual_squared ** 0.5

    out["frac"] = {}
    out["frac"]["mesh_size"] = h_1
    out["frac"]["error"] = fracture_error
    out["frac"]["diffusive_error"] = fracture_diffusive_squared ** 0.5
    out["frac"]["residual_error"] = fracture_residual_squared ** 0.5
